...
parse.Salmon.etal.data <- function(dataf) {
  ...
  MC4100.ids <- read.csv('../data/MC4100_IDs.csv', header = TRUE, as.is=TRUE) %>%
...
## write out data files for other analyses.
## for metagenomics analysis, we want
## anaerobic-specific and aerobic-specific genes.
...
## for metagenomics analysis, we want genes that are
